...
class Products(models.Model):
    ...
    prod_description = models.CharField(max_length=45)
...
class Provider(models.Model):
    ...
    prov_address = models.CharField(max_length=45)
    ...
    prov_email = models.CharField(max_length=45, blank=True, null=True)
